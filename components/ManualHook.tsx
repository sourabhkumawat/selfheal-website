  ...
  return (
    <section className="relative py-24 sm:py-28">
      <div className="container-x">
        ...
        >
          <div>
            <motion.div variants={fadeUp} className="eyebrow flex items-center gap-2">
            ...
            <motion.h2 variants={fadeUp} className="heading-lg mt-4">
              ...
              <span className="text-ink-300">
                Or you can let HealOps do it before the page even reaches
                your phone.
              </span>
            </motion.h2>
            <motion.p variants={fadeUp} className="lead mt-5">
              The cost of an incident isn't the bug — it's the hours of
              human attention spent rebuilding context every single time.
              HealOps was built to take that work back.
            </motion.p>
            <motion.a
              variants={fadeUp}
              href="#loop"
          ...
          >
              ...
              return (
                ...
                >
                  <div className="grid place-items-center size-10 rounded-lg bg-danger-400/10 ring-1 ring-danger-400/20 shrink-0">
                    <Icon className="size-5 text-danger-400/80" strokeWidth={1.7} />
                  </div>
                  <div>
            ...
            <div className="mt-2 pl-2 font-mono text-[11px] tracking-wider text-ink-400">
              ↑ this is the part HealOps replaces.
            </div>
          </motion.div>
        </motion.div>
      </div>
