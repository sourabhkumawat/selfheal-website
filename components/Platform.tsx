            ...
            <div className="container-x">
                ...
                >
                    ...
                    <motion.p variants={fadeUp} className="lead mt-5">
                        Most "AI on-call" tools are wrappers around a chat
                        window. They paste a stack trace into a model and hand
                        the answer back to you. selfheal is built on two
                        assumptions that change what an SRE agent is allowed to
                        do — and what it's allowed to ship.
                    </motion.p>
                </motion.div>
                ...
                <div className="mt-14 grid lg:grid-cols-2 gap-6">
                    ...
                    >
                        ...
                        <h3 className="mt-4 font-display text-[26px] sm:text-[30px] font-medium leading-tight">
                            The fix ships as a{' '}
                            <span className="text-heal-400">pull request</span>,
                            not a deploy.
                        </h3>
                        <p className="mt-4 text-ink-200 leading-relaxed">
                            Auto-remediation tools want to push the change. We
                            don't. selfheal opens a PR on your repo, with the
                            diff, the regression test, and the evidence trail.
                            Your reviewer is still the merge button. Production
                            stays under human gates — the agent just removes the
                            3 AM typing.
                        </p>
                        ...
                        <div className="mt-7 rounded-xl border border-ink-800 bg-ink-900/60 p-4 font-mono text-[12px] text-ink-200">
                            ...
                            <div className="mt-3 grid grid-cols-[12px_1fr] gap-x-2 leading-relaxed">
                                ...
                                <span className="text-ink-300">
                                    conn.retry(after).then(close)
                                </span>
                                <span className="text-heal-400">+</span>
                                <span className="text-ink-100">
                                    await conn.close(); retry(after)
                                </span>
                            </div>
                    ...
                    >
                        ...
                        <p className="mt-4 text-ink-200 leading-relaxed">
                            The agent reads against a read-only role inside your
                            account. There is no selfheal data lake. When an
                            incident fires, we fetch the narrow time-and-actor
                            slice the investigation needs — nothing else. Zero
                            standing access to your code, zero bulk egress of
                            your telemetry.
                        </p>

                        <div className="mt-7 grid grid-cols-2 gap-3">
                            <Stat
                                label="Logs egressed at rest"
                                value="0 bytes"
                                tone="heal"
                            />
                            <Stat
                            ...
                            />
                            <Stat
                                label="Slice pulled on incident"
                                value="≈ 14m window"
                                tone="signal"
                            />
                            <Stat
...
function Stat({
    ...
    return (
        <div className="rounded-lg border border-ink-800/80 bg-ink-900/40 p-3">
            ...
            <div className={`mt-1.5 font-display text-[18px] ${tones[tone]}`}>
                {value}
            </div>
        </div>
    );
