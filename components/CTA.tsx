        ...
        >
          ...
          <div className="relative max-w-3xl">
            ...
            <motion.h2 variants={fadeUp} className="heading-lg mt-4">
              ...
              <span className="text-heal-400">morning standup.</span>
            </motion.h2>
            <motion.p variants={fadeUp} className="lead mt-5">
              Twenty minutes to connect. Forty minutes to verify the agent
              against a synthetic failure. After that — every page comes
              with a draft fix attached.
            </motion.p>
            ...
            >
              <div>
                ...
                <div className="text-ink-400">to connect a read-only role</div>
              </div>
              <div>
                <div className="text-ink-100">1h</div>
                <div className="text-ink-400">to validate against a synthetic incident</div>
              </div>
              <div>
                <div className="text-ink-100">0</div>
                <div className="text-ink-400">bytes of logs leaving your cloud at rest</div>
              </div>
            </motion.div>
          </div>
        </motion.div>
