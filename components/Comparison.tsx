            ...
            <div className="container-x">
                ...
                >
                    ...
                    <motion.p variants={fadeUp} className="lead mt-5">
                        Modern incident response is mostly handoff cost — pager
                        to human, human to dashboard, dashboard to repo, repo to
                        reviewer. selfheal removes every handoff that doesn't
                        involve a human judgement call.
                    </motion.p>
                </motion.div>
                ...
                >
                    ...
                    {rows.map((row, i) => (
                        ...
                        >
                            <div className="px-5 py-5 text-[14px] text-ink-200">
                                {row.label}
                            </div>
