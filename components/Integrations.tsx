                    ...
                    <div>
                        ...
                        >
                            ...
                            <span className="text-ink-300">
                                Writes only to your repo.
                            </span>
                        </motion.h2>
                        <motion.p variants={fadeUp} className="lead mt-5">
                            60+ connectors across observability, infrastructure,
                            source control and communication. Connect what you
                            already run — selfheal does the correlation, the
                            investigation and the fix-in-a-PR on top.
                        </motion.p>
                        <motion.div
                            variants={fadeUp}
