        ...
        >
          <div>
            ...
            <motion.h1 variants={fadeUp} className="heading-xl">
              ...
              <span className="shimmer-text">It ships the fix.</span>
            </motion.h1>

            <motion.p variants={fadeUp} className="lead mt-6">
              HealOps investigates the moment an alert fires — correlates
              signals across logs, traces and configs, tests hypotheses in
              parallel, isolates the root cause, then{" "}
              <span className="text-ink-100">opens a reviewed pull request</span>{" "}
              with a regression test attached. Incident in. Diff out.
