      ...
      <div className="container-x relative">
        ...
        >
          ...
          <motion.h2 variants={fadeUp} className="heading-lg mt-4">
            ...
            <span className="text-ink-300">
              Everything in between is automated, auditable, and parallel.
            </span>
          </motion.h2>
        </motion.div>
            ...
            {steps.map((s, idx) => {
              ...
              return (
                ...
                >
                  ...
                  <h3 className="mt-1 font-display text-[18px] font-medium">{s.title}</h3>
                  <p className="mt-2 text-[13.5px] leading-relaxed text-ink-300">
                    {s.body}
                  </p>
                  {s.accent && (
                    <div className="mt-4 chip-heal w-fit">closes the page</div>
                  )}
                </motion.div>
              );
            })}
        ...
        >
          <div className="glass-card p-6 sm:p-8 relative overflow-hidden">
            <div className="eyebrow">Why one agent for the whole loop</div>
            ...
            <p className="mt-3 text-ink-200 max-w-xl leading-relaxed">
              Tools that stop at "root cause report" force someone to
              re-derive the patch from the evidence — at 3 AM, under pager
              pressure, with the context already half-gone. HealOps keeps
              every link between symptom, hypothesis, evidence and diff in
              one continuous chain, so the PR description is just the
              investigation, written down.
            </p>
            <div className="mt-5 flex flex-wrap gap-2">
              <span className="chip-signal">01 → 04 · investigate</span>
              <span className="chip-heal">05 → 06 · heal &amp; learn</span>
              <span className="chip">one agent · one chain of custody</span>
            </div>
          </div>

          <div className="glass-card p-6 sm:p-8 relative overflow-hidden">
            <div className="eyebrow">A real PR description, written by HealOps</div>
