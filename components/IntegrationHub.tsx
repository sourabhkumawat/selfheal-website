...
const COMPANY_LOGOS = [
    {
        name: 'At The Rate',
        src: '/logos/attherate.svg',
        url: 'https://attherate.ai'
    },
    {
        name: 'Firecoach',
        src: '/logos/firecoach-logo.svg',
        url: 'https://firecoach.ai'
    },
    { name: 'FMH', src: '/logos/fmh.svg', url: 'https://foodmarkethub.com' },
    {
        name: 'Guardr AI',
        src: '/logos/guardr_ai_logo.png',
        url: 'https://guardr.ai'
    },
    {
        name: 'Tribe HQ AI',
        src: '/logos/tribehqai.png',
        url: 'https://tribehq.ai'
    }
];
 ...
 * --------------------------------------------------
 * Every integration selfheal supports, arranged on an
            ...
            <div className="container-x">
                ...
                >
                    ...
                    <motion.h2 variants={fadeUp} className="heading-lg mt-3">
                        selfheal sits in the middle of your stack —{' '}
                        <span className="text-ink-300">
                            {ALL_NODES.length} integrations, one continuous
                            chain of custody from page to pull request.
                        </span>
                    </motion.h2>
                </motion.div>
            </div>
                    ...
                    >
                        <defs>
                            ...
                            >
                                <stop
                                    offset="0%"
                                    stopColor="rgba(52,211,153,0.32)"
                                />
                                <stop
                                    offset="60%"
                                    stopColor="rgba(52,211,153,0.05)"
                                />
                    ...
                    <div className="flex flex-wrap items-center justify-between gap-3 text-[11.5px] font-mono text-ink-300 border-t border-ink-800/60 pt-4">
                        <div className="flex flex-wrap items-center gap-x-5 gap-y-2">
                            {CATEGORIES.map((c) => (
                                ...
                                >
                                    <span
                                        className={`size-1.5 rounded-full ${c.color.dot}`}
                                    />
                                    <span className={c.color.label}>
                                        {c.label}
                                    </span>
