...
const cols = [
    {
        title: 'Platform',
        items: [
            { label: 'How selfheal works', href: '#loop' },
    ...
    },
    {
        ...
        items: [
            ...
            { label: 'Email the founders', href: `mailto:${FOUNDERS_EMAIL}` },
            {
                ...
                href: 'mailto:security@selfheal.ai'
            }
        ]
    }
];
        ...
        <footer className="relative pt-16 pb-10 border-t border-ink-800/80">
            <div className="container-x">
                    ...
                    <div>
                        <Link href="/" className="flex items-center gap-2.5">
                            ...
                            <span className="font-display text-[15px] font-semibold tracking-tight">
                                selfheal
                                <span className="text-heal-400">.ai</span>
                            </span>
                        </Link>
                        <p className="mt-4 max-w-sm text-[14px] text-ink-300 leading-relaxed">
                            The autonomous SRE that doesn't just find the bug —
                            it ships the fix. One agent for the whole incident
                            loop, from page to pull request.
                        </p>
                        <div className="mt-5 flex flex-wrap gap-2">
                            <span className="chip-heal">SOC 2 path</span>
                            <span className="chip">
                                Logs stay in your cloud
                            </span>
                        </div>
                    </div>
                ...
                <div className="mt-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 font-mono text-[11.5px] text-ink-400">
                    <div>
                        © {new Date().getFullYear()} selfheal, Inc. · all
                        incidents close.
                    </div>
