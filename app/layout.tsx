...
export const metadata: Metadata = {
    title: 'selfheal — the AI SRE that ships the fix',
    description:
        'selfheal is an autonomous SRE agent that investigates production incidents, finds the root cause, and opens a reviewed pull request that closes the loop.',
    metadataBase: new URL('https://selfheal.ai'),
    openGraph: {
        title: 'selfheal — the AI SRE that ships the fix',
        description:
